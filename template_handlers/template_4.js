...
"Kirish$Tikuvchilik tarixi$Tikuvchilik turlari$Matolar va xususiyatlari$Tikuvchilik asbob-uskunalari$Andaza va bichish jarayoni$Tikish texnikalari$Zamonaviy tikuvchilik tendensiyalari$Tikuvchilikning iqtisodiy ahamiyati$Xulosa"`;
    ...
    secondSlide.addText(`${plan[0] || 'Kirish'}`, { x: 4.8, y: 1.57, fontSize: 18, fontFace: "Agency FB", bold: true, color: "000000", w: "45%" });
    secondSlide.addText(`${plan[1] || 'Mavzu 1'}`, { x: 4.8, y: 2.23, fontSize: 18, fontFace: "Agency FB", bold: true, color: "000000", w: "45%" });
    secondSlide.addText(`${plan[3] || 'Mavzu 3'}`, { x: 4.8, y: 2.85, fontSize: 18, fontFace: "Agency FB", bold: true, color: "000000", w: "45%" });
    secondSlide.addText(`${plan[5] || 'Mavzu 5'}`, { x: 4.8, y: 3.52, fontSize: 18, fontFace: "Agency FB", bold: true, color: "000000", w: "45%" });
    secondSlide.addText(`${plan[7] || 'Mavzu 7'}`, { x: 4.8, y: 4.15, fontSize: 18, fontFace: "Agency FB", bold: true, color: "000000", w: "45%" });
    ...
    thirdSlide.addText(kirish1Text, {
      x: 4.6, y: 1.33, fontSize: 15, fontFace: "Agency FB", color: "000000", w: "45%", valign: "top",
    });
    thirdSlide.addText(kirish2Text, {
      x: 4.6, y: 2.62, fontSize: 15, fontFace: "Agency FB", color: "000000", w: "45%", valign: "top",
    });
    thirdSlide.addText(kirish3Text, {
      x: 4.6, y: 3.88, fontSize: 15, fontFace: "Agency FB", color: "000000", w: "45%", valign: "top",
    });
...
3 ta paragraf:`;
    ...
    sixSlide.addText(page6Text[0], {
      x: 0.67, y: 2.45, align: "center", fontSize: 12, fontFace: "Times New Roman", color: "000000", w: 2.71, h: 2.26, valign: "top",
    });
    sixSlide.addText(page6Text[1], {
      x: 3.66, y: 2.45, align: "center", fontSize: 12, fontFace: "Times New Roman", color: "000000", w: 2.72, h: 2.26, valign: "top",
    });
    sixSlide.addText(page6Text[2], {
      x: 6.73, y: 2.45, align: "center", fontSize: 12, fontFace: "Times New Roman", color: "000000", w: 2.73, h: 2.26, valign: "top",
    });
